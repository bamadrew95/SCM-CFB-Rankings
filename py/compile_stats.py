...
class Compile:
    ...
    def read_db(self):
        file_team_index = (
            "C:/Users/bamadrew95/Documents/Rankings/SCM Development/FBS-Stats-Scraper-master/data/stats/"
            + self.year
            + "stats.xlsx"
        )
        self.team_index = pd.read_excel(file_team_index, sheet_name="Team Index")
    ...
    def compile_stats(self):
        ...
        # Write to excel file
        write_to_db.excel(self.year, "stats", "Raw Stats", self.stats_df)
